...
class MapReduce{
    ...
    public:
        ...
        void primary_map_task(float* to_mapper,long long int n,float* mapped_pairs);
        ...
        void secondary_map_task(bool* d ,float* to_mapper,long long int n,float* mapped_pairs);
